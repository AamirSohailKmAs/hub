...
(function kmCodeColor() {
    ...
    function kmCodeColorize(x, lang) {
        ...
        function sqlMode(txt) {
            var rest = txt,
                y, done = "",
                sfnuttpos, dfnuttpos, compos, comlinepos, keywordpos, numpos, mypos;
            y = 1;
            while (y == 1) {
                ...
                if (Math.max(numpos[0], sfnuttpos[0], dfnuttpos[0], compos[0], comlinepos[0], keywordpos[0]) == -1) {
                    break;
                }
        ...
        function phpMode(txt) {
            var rest = txt,
                ...
                sfnuttpos, dfnuttpos, compos, comlinepos, comhashpos, keywordpos, mypos, y;
            y = 1;
            while (y == 1) {
